...
| Placement             | A `/shared` modal route group                           | A share can arrive on any tab or with the app cold. A modal presented over the tab controller is tab-agnostic; which tab dismissing lands on is unsettled — see check 36.                                                                                                              |
...
| oEmbed timeout or 5xx                                   | 502 problem                                                                                             |
